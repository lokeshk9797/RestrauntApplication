...
{
    class Dominos: Restro
    {
   
        public override string RestroName => "Dominos";

        public override string RestroBranch => "Manish Nagar,Nagpur";

        public override void SetItems()
        {
            itemList.Add(new ItemModel { ItemId = 1, ItemName = "Corn Pizza", ItemPrice = 40.00, IsAvailable = true });
            itemList.Add(new ItemModel { ItemId = 2, ItemName = "Soya Pizza   ", ItemPrice = 70.00, IsAvailable = true });
            itemList.Add(new ItemModel { ItemId = 3, ItemName = "Barbeque Chicken Pizza", ItemPrice = 200.00, IsAvailable = true });
